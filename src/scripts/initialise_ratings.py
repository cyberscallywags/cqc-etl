...
from src.utils.queries import INITIALISE_RATINGS_QUERIES
from src.utils.connectors import connect_duckdb
from src.utils.transforms import combine_parquet, create_dfs, run_queries, export_tables
from src.config import ARCHIVE_DATA_DIR, INTERIM_DATA_DIR, SCHEMAS_DIR
...
if __name__ == "__main__":
    ...
    con = connect_duckdb()
    create_dfs(con, file_registry, SCHEMAS_DIR / "initialise_01.json")
    run_queries(con, INITIALISE_RATINGS_QUERIES)
